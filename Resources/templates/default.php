...
<body>
<?php
$classForStatusCode = null;

if (http_response_code() >= 100 && http_response_code() < 200 || http_response_code() >= 300 && http_response_code() < 400) {
    $classForStatusCode = 'orange';
} else if (http_response_code() >= 200 && http_response_code() < 300) {
    $classForStatusCode = 'green';
} else if (http_response_code() >= 400) {
    $classForStatusCode = 'red';
}

$responseTime = $this->getToolbarInfo()->getResponseTime();
$classResponseTime = null;

if ($responseTime < 1000) {
    $classResponseTime = 'green';
} else if ($responseTime < 1700) {
    $classResponseTime = 'orange';
} else {
    $classResponseTime = 'red';
}
?>
<div class="__cdm-toolbar active">
    <ul class="__cdm-toolbar_navigation">
        <div class="__cdm-toolbar_navigation-flex">
            <span class="__cdm-toolbar-username">
                User: @<?php echo get_current_user(); ?>
            </span>
            <span class="__cdm-toolbar_status-code __cdm-toolbar_status-code_<?php echo $classForStatusCode; ?>">
                <?php echo http_response_code(); ?>
            </span>
            <span class="__cdm-toolbar_response-time __cdm-toolbar_response-time_<?php echo $classResponseTime; ?>">
                <?php echo $responseTime; ?> ms
            </span>
            <li class="__cdm-navigation_item">
                <div class="__cdm-navigation_item-btn">
                    <?php if (count($this->getToolbarInfo()->getVarDumper()) > 0): ?>
                        <span class="__cdm-navigation_item-btn_count"><?php echo count($this->getToolbarInfo()->getVarDumper()); ?></span>
                    <?php endif; ?>
                    <i class="fas fa-spider"></i> Dump
                </div>
                <div class="__cdm-toolbar-navigation_modal">
                    <?php echo implode('', $_SERVER['VAR_DUMPER'] ?? []) ?>
                </div>
            </li>
            <li class="__cdm-navigation_item">
                <div class="__cdm-navigation_item-btn">
                    <?php if (count($this->getToolbarInfo()->getInfo()) > 0): ?>
                        <span class="__cdm-navigation_item-btn_count"><?php echo count($this->getToolbarInfo()->getInfo()); ?></span>
                    <?php endif; ?>
                    <i class="fas fa-info-circle"></i> Information
                </div>
                <div class="__cdm-toolbar-navigation_modal __cdm-toolbar-news">
                    <?php foreach ($_SERVER['CDM_INFO'] ?? [] as $new): ?>
                        <div>
                            <?php echo $new; ?>
                        </div>
                    <?php endforeach; ?>
            ...
            <li class="__cdm-navigation_item">
                ...
                <div class="__cdm-toolbar-navigation_modal __cdm-toolbar-settings">
                    <div>
                        <span>Turning the toolbar on and off</span>
                        <span><mark>CTRL</mark> + <input type="text" class="__cdm-input_key"></span>
                    </div>
                </div>
            </li>
        </div>
        <svg class="__cdm-logo" xmlns="http://www.w3.org/2000/svg" version="1.1" xlink="http://www.w3.org/1999/xlink"
             width="100%" height="100%" preserveAspectRatio="xMidYMid meet"
             viewBox="-0.000001515847657174163 1.6513774880877463e-7 300 64.49533081054688" overflow="visible">
            <defs id="SvgjsDefs527886">
                <linearGradient id="SvgjsLinearGradient7FFg4fMxE" gradientUnits="userSpaceOnUse" x1="5.045999999999963"
                                y1="94.95300000000006" x2="94.95400000000001" y2="5.045000000000001">
                    <stop id="SvgjsStop527890" stop-color="#a35281" offset="0"></stop>
                    <stop id="SvgjsStop527891" stop-color="#2f2f33" offset="1"></stop>
                </linearGradient>
                <linearGradient id="SvgjsLinearGradientOA3yBa-o2s" gradientUnits="userSpaceOnUse"
                                x1="-106.32999999999997" y1="91.51" x2="107.57" y2="-122.39000000000001">
                    <stop id="SvgjsStop527894" stop-color="#a35281" offset="0"></stop>
                    <stop id="SvgjsStop527895" stop-color="#2f2f33" offset="1"></stop>
                </linearGradient>
            </defs>
            <g id="SvgjsG527887" transform="scale(0.5992690999190103)" opacity="1">
                <g id="SvgjsG527888" class="Yxbm7ED0s"
                   transform="translate(115.42815614905311, 9.7891416595036) scale(1)" light-content="false"
                   fill="#5757cc" style="fill: #8b26d038;">
                    <path d="M 75.54083506094494, 44.91708385469828m 0, -44.91708385469828a 76.04083506094494, 44.91708385469828, 0, 1, 0, 1, 0Z"></path>
                </g>
                <g id="SvgjsG527892" class="ytz8PB6Hj"
                   transform="translate(-6.305504587181328, -5.706737585604545) scale(1.190391653234157)"
                   light-content="false" non-strokable="false" fill="url(#SvgjsLinearGradient7FFg4fMxE)">
                ...
                <g id="SvgjsG527896" class="text" transform="translate(312.439826270943, 72.52379175497586) scale(1)"
                   light-content="false" fill="url(#SvgjsLinearGradientOA3yBa-o2s)">
